...
import 'package:meal4you_app/services/logout/client_global_logout_service.dart';
import 'package:meal4you_app/services/logout/client_logout_service.dart';
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          ...
          content: const Text(
            'Deseja sair apenas deste dispositivo ou de todos os dispositivos?',
          ),
          actions: <Widget>[
            TextButton(
            ...
            TextButton(
              ...
              child: const Text('Apenas este dispositivo'),
            ),
            // ElevatedButton(
            //   onPressed: () async {
            //     Navigator.of(dialogContext).pop();
